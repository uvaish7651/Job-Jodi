...
const CompanyCreate = () => {
    ...
    const registerNewCompany = async () => {
        try {
            console.log("Data sending to backend:", { companyName });
        ...
        <div>
            ...
            <div className='max-w-4xl mx-auto'>
                ...
                <div className='flex items-center gap-2 my-10'>
                    ...
                    <Button className="cursor-pointer bg-blue-600 hover:bg-blue-700" onClick={registerNewCompany}>Continue</Button>
                </div>
            </div>
        </div>
    )
